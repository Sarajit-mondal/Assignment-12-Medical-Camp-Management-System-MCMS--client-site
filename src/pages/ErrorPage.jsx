...
const ErrorPage = () => {
  ...
  return (
    <section className='bg-white '>
      <div className='container flex items-center min-h-screen px-6 py-6 mx-auto'>
        <div className='flex flex-col items-center max-w-sm mx-auto text-center'>
         <img src="https://img.freepik.com/premium-vector/website-construction-illustration_86047-169.jpg?w=740" alt="" />
